...
- If user asks for projects matching filters (status, jurisdiction, project type, sub-watershed, or any district), use list_lake_county_projects(...). Use subshed when they specify sub-watershed (e.g. "projects in Lake Michigan subshed"). For districts use exactly one of: county_board_district (County Board, e.g. "5"), drainage_district (Drainage, e.g. "Union No 1"), state_senate_district (State Senate, e.g. "31"), state_representative_district (State Rep, e.g. "59"), us_congressional_district (U.S. Congressional, e.g. "10"). Examples: "projects in county board district 5" -> county_board_district="5"; "projects in state senate district 31" -> state_senate_district="31"; "projects in US congressional district 10" -> us_congressional_district="10".
